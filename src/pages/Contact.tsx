  ...
  const serviceTypes = [
    {
      ...
      contact: "Call (647) 914-9185 immediately"
    },
    {
  ...
  return (
    <>
      <SEO 
        ...
        description="Need towing in Toronto or the GTA? Call (647) 914-9185 now for help. We're here 24/7. Fast response. Get a quote or emergency assistance."
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {contactMethods.map((method, index) => (
              <Card key={index} className={`p-8 text-center bg-service-card border-service-border ${method.primary ? 'ring-2 ring-tow-red' : ''}`}>
                ...
                >
                  {method.primary ? (
                    <a href="tel:+16479149185">{method.action}</a>
            ...
            <Card className="p-8 bg-service-card border-service-border">
              ...
              <div className="mt-6 p-4 bg-muted/50 rounded-lg">
                <p className="text-sm text-muted-foreground text-center">
                  <strong>For immediate assistance or emergencies, call (647) 914-9185</strong>
                  <br />
