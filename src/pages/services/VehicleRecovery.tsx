...
const VehicleRecovery = () => {
  ...
  return (
    <>
      <SEO 
        title="Vehicle Recovery Toronto & GTA | Pull Your Car from Ditches, Mud, Accidents | TowDaddy"
        description="Car stuck in Toronto or the GTA? Accident? Ditch? Mud? We pull it out safe. Expert recovery. Call now! From $150."
        keywords="vehicle recovery Toronto GTA, accident recovery Toronto, off-road recovery, winch service Toronto, ditch recovery GTA, rollover recovery Toronto"
              ...
              <div className="max-w-4xl mx-auto text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
                  <Button variant="towRed" size="lg" className="text-sm sm:text-base" asChild>
                    <a href="tel:+16479149185">
                      <Phone className="w-4 h-4 sm:w-5 sm:h-5 mr-2" />
                      Emergency: (647) 914-9185
                    </a>
                  </Button>
                  <Button variant="outline" size="lg" asChild className="bg-background/10 border-hero-foreground/30 text-hero-foreground hover:bg-background/20 text-sm sm:text-base">
                    <a href="https://request.towdaddy.ca/" target="_blank" rel="noopener noreferrer">Get Recovery Quote</a>
                  </Button>
                </div>
              </div>
            </div>
