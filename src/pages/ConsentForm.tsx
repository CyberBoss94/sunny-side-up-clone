...
const ConsentForm = () => {
  ...
  const canProceedToStep3 = () => {
    const step2Fields: (keyof FormData)[] = [
      "vin_number", "destination_address", 
      "consenter_first_name", "consenter_last_name"
    ];
  ...
  const handleNext = async () => {
    ...
    if (currentStep === 1) {
      fieldsToValidate = [
        ...
        "vehicle_year", "license_plate", "pickup_address"
      ];
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid gap-4 md:grid-cols-2">
                      ...
                      <div className="space-y-2">
                        ...
                        {errors.driver_email && (
                          <p className="text-sm text-destructive">{errors.driver_email.message}</p>
                        )}
                      </div>
                    </div>
                    ...
                    <div className="grid gap-4 md:grid-cols-3">
                      <div className="space-y-2">
                        ...
                        {errors.vehicle_make && (
                          <p className="text-sm text-destructive">{errors.vehicle_make.message}</p>
                        )}
                      </div>
                ...
                {currentStep === 2 && (
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      {errors.vin_number && (
                        <p className="text-sm text-destructive">{errors.vin_number.message}</p>
                      )}
                    </div>
                    ...
                    <div className="grid gap-4 md:grid-cols-2">
                      <div className="space-y-2">
                        ...
                        {errors.consenter_first_name && (
                          <p className="text-sm text-destructive">{errors.consenter_first_name.message}</p>
                        )}
                      </div>
                      ...
                      <div className="space-y-2">
                        ...
                        {errors.consenter_last_name && (
                          <p className="text-sm text-destructive">{errors.consenter_last_name.message}</p>
                        )}
                      </div>
                    </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="rounded-lg border bg-muted/50 p-4">
                      ...
                      {errors.terms_accepted && (
                        <p className="mt-2 text-sm text-destructive">{errors.terms_accepted.message}</p>
                      )}
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="rounded-lg border bg-white p-2">
                        <canvas
                          ...
                          width={600}
                          height={200}
                          className="w-full touch-none border"
